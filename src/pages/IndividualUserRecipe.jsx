...
const IndividualUserRecipe = ({ match, setParameters, userRecipes, user }) => {
    ...
    let fetchedRecipe = {};
    let recipes;
    let name, userName, category, image, link, description ;


let handleRecipeFetching = async =>{

    if (user) {
        userRecipes.filter((recipe, index) => index === recipeParameters).map((recipe) => fetchedRecipe = recipe.UsersRecipes)
        ...
        <div>
            ...
            <div id="page-title" class="padding-tb-30px gradient-white">
                <div class="container text-left">
                    ...
                    <h1 class="font-weight-300">{name}</h1>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="margin-bottom-40px card border-0 box-shadow">
                            <div class="card-img-top"><a href="/">
                                <img style={{ marginLeft: "auto", marginTop: "15px", marginRight: "auto", display: "block" }} src={image} alt={name} /></a>
                            </div>
                            <div class="padding-lr-30px padding-tb-20px">
                                <h5 class="margin-bottom-20px margin-top-10px"><a class="text-dark" href="/">{name}</a></h5>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-4 text-left"><a href="#" class="text-red"><i onClick={"handleSave"} class="fa fa-share-alt"></i> Share</a></div>
                                    <div class="col-8 text-left"><a href="/" class="text-grey-2"><i class="fas fa-users" style={{ marginRight: "0px" }}></i> Servings: 2 </a></div>
                            ...
                            <div class="background-light-grey border-top-1 border-grey padding-lr-30px padding-tb-20px">
                                ...
                                <a href={link} class="d-inline-block text-grey-3 h6 margin-bottom-0px margin-right-15px"><img src="http://placehold.it/50x50" class="height-30px border-radius-30 margin-right-15px" alt="" /> {userName}</a>
                            </div>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(IndividualUserRecipe)
